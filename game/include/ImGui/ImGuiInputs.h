...
// starts input field
 void BeginInput(const char* label)
{
    ImGui::PushID(label);
...
// shows vec3 input field
 bool InputVec3(const char* label, glm::vec3* value) 
{
    BeginInput(label);        
...
// shows bool input field
 bool InputColor(const char* label, float* value) 
{
    BeginInput(label);        
...
// shows combo input field
 bool InputCombo(const char* label, const std::vector<const char*>& combos) 
{
    BeginInput(label);    
...
// shows text input field
 bool InputText(const char* label, char* value, const char* hint = nullptr, size_t size = 32) 
{
    BeginInput(label);    
